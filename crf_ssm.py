...
def crf():
    ...
    :return:
    '''
    fn_im = '/home/zq/output/segnet_output/3rd_segnet_epoch_30_bs_2_new_image_100000/predict/pred/6.png'
    fn_anno = '/home/zq/output/segnet_output/3rd_segnet_epoch_30_bs_2_new_image_100000/predict/final_visualize/6_final.png'
    fn_output = '/home/zq/output/segnet_output/3rd_segnet_epoch_30_bs_2_new_image_100000/predict/crf/CRF6'
...
'''
for path in os.listdir('/home/zq/output/segnet_output/3rd_segnet_epoch_30_bs_2_new_image_100000/predict/'):
    print(path)
    crf(path,path,path)
'''
